...
HRESULT CVIBuffer::Bind_Buffers()
{
	...
	// 메모리 공간을 어디서부터 바인딩 할거야? - 보통은 0(처음)
	_uint		iOffsets[] = {
		0,
		/*0,*/
	};
	...
	/* 내 정점이 어떠한 멤버들을 가지고 있어요. - DX9에서 주었던 정보*/
...
{
	/* D3D11_BUFFER_DESC : 생성하고자하는 버퍼의 속성(크기를 몇바이트로?, 버퍼를 정적? 동적? 등등) 을 설정한다. */
	/* D3D11_SUBRESOURCE_DATA : 멤버로 void* 를 가지고 있다. void*에 내가 생성하고자하는 버퍼에 담을 값들을 내가 미리할당하여 채우고, 할당한 공간의 주소를 대입해준다. */
