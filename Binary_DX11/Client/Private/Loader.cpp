...
HRESULT CLoader::Ready_Resources_For_GamePlayLevel()
{
	...
	//	CModel::Create(m_pDevice, m_pContext, CModel::TYPE_ANIM, "../Bin/Resources/Models/Player/Player_Arm.fbx", "../Bin/ModelData/Anim/Player/", PreTransformMatrix))))
	//	return E_FAIL;
	// 
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_GAMEPLAY, TEXT("Prototype_Component_Model_SteelHeart"),
		CModel::Create(m_pDevice, m_pContext, CModel::TYPE_ANIM, "../Bin/Resources/Models/SteelHeart/SteelHeart.fbx", "../Bin/ModelData/Anim/SteelHeart/", PreTransformMatrix))))
		return E_FAIL;
...
HRESULT CLoader::Ready_Resources_Object()
{
	...
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_GAMEPLAY, TEXT("Prototype_Component_Model_Throw_Battery"),
		CModel::Create(m_pDevice, m_pContext, CModel::TYPE_NONANIM, "../Bin/Resources/Models/ThrowItem/Battery.fbx", "../Bin/ModelData/NonAnim/ThrowItem/", PreTransformMatrix))))
		return E_FAIL;

	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_GAMEPLAY, TEXT("Prototype_Component_Model_Throw_Cluster"),
		CModel::Create(m_pDevice, m_pContext, CModel::TYPE_NONANIM, "../Bin/Resources/Models/ThrowItem/Cluster.fbx", "../Bin/ModelData/NonAnim/ThrowItem/", PreTransformMatrix))))
		return E_FAIL;

	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_GAMEPLAY, TEXT("Prototype_Component_Model_Throw_Thermite"),
		CModel::Create(m_pDevice, m_pContext, CModel::TYPE_NONANIM, "../Bin/Resources/Models/ThrowItem/Thermite.fbx", "../Bin/ModelData/NonAnim/ThrowItem/", PreTransformMatrix))))
		return E_FAIL;

	return S_OK;
}

HRESULT CLoader::Ready_Resources_CutScene()
{
	_matrix		PreTransformMatrix = XMMatrixIdentity();

#pragma region Raxasia
	///* For. Prototype_Component_Model_Monster_Raxasia_CutScene_P1 */
	//if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_GAMEPLAY, TEXT("Prototype_Component_Model_Monster_Raxasia_CutScene_P1"),
	//	CModel::Create(m_pDevice, m_pContext, CModel::TYPE_ANIM, "../Bin/Resources/Models/Monster/Boss/Raxasia/Raxasia_CutScene_P1.fbx", "../Bin/ModelData/Anim/Monster/Boss/Raxasia/", PreTransformMatrix))))
	//	return E_FAIL;

	///* For. Prototype_Component_Model_Monster_Raxasia_CutScene_P2 */
	//if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_GAMEPLAY, TEXT("Prototype_Component_Model_Monster_Raxasia_CutScene_P2"),
	//	CModel::Create(m_pDevice, m_pContext, CModel::TYPE_ANIM, "../Bin/Resources/Models/Monster/Boss/Raxasia/Raxasia_CutScene_P2.fbx", "../Bin/ModelData/Anim/Monster/Boss/Raxasia/", PreTransformMatrix))))
	//	return E_FAIL;

	///* For. Prototype_Component_Model_Monster_Raxasia_CutScene_Sword */
	...
	/* For. Prototype_Component_Model_Monster_Raxasia_CutScene_Helmet */
	if (FAILED(m_pGameInstance->Add_Prototype(LEVEL_GAMEPLAY, TEXT("Prototype_Component_Model_Monster_Raxasia_CutScene_Helmet"),
		CModel::Create(m_pDevice, m_pContext, CModel::TYPE_ANIM, "../Bin/Resources/Models/Monster/Boss/Raxasia/Raxasia_CutScene_Helmet.fbx", "../Bin/ModelData/Anim/Monster/Boss/Raxasia/", PreTransformMatrix))))
		return E_FAIL;
#pragma endregion
