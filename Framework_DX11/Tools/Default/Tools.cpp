// Tools.cpp : 애플리케이션에 대한 진입점을 정의합니다.
//
    ...
    _In_ int       nCmdShow)
{
    ...
    LoadStringW(hInstance, IDC_TOOLS, szWindowClass, MAX_LOADSTRING);
    ...
    HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_TOOLS));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.hIcon = LoadIcon(hInstance, MAKEINTRESOURCE(IDC_TOOLS));
...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
    ...
    RECT		rcWindowed = { 0, 0, Tools::g_iWinSizeX, Tools::g_iWinSizeY };

    AdjustWindowRect(&rcWindowed, WS_CAPTION | WS_SYSMENU, FALSE);
