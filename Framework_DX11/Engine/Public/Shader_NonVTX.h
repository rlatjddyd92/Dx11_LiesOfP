...
class ENGINE_DLL CShader_NonVTX final : public CComponent
{
private:
	CShader_NonVTX(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CShader_NonVTX(const CShader_NonVTX& Prototype);
	virtual ~CShader_NonVTX() = default;
...
public:
	static CShader_NonVTX* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext, const _tchar* pShaderFilePath);
