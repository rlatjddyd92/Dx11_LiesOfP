...
public:
	...
	virtual _bool Calc_DamageGain(_float fAtkDmg, _Vec3 vHitPos = { 0.f,0.f,0.f }, _uint iHitType = 0, _uint iAttackStrength = 0, CGameObject* pAttacker = nullptr) { return false; }
