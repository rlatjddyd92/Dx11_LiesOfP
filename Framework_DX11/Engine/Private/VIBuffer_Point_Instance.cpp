...
_bool CVIBuffer_Point_Instance::Spread(_uint iState, _float fRenderRatio, _Vec4 vPivot, _float fSpeed, _float fGravity, _float fTimeDelta, _Vec3 vRevolveAxis, _float fAngle, _float fTimeInterval, _float fRandomRatio)
{
	if (1.f < fRenderRatio)
		fRenderRatio = 1.f;
	...
	for (size_t i = 0; i < m_iNumInstance; i++)
	{
		...
		_Vec4		vMoveDir = vDir * m_pSpeed[i] * fSpeed;
		vMoveDir.y -= fGravity * pVertices[i].vLifeTime.y;

		pVertices[i].vTranslation = pVertices[i].vTranslation + vMoveDir * fTimeDelta + vRotateDir;
...
_bool CVIBuffer_Point_Instance::Move(_uint iState, _float fRenderRatio, _Vec4 vDir, _float fSpeed, _float fGravity, _float fTimeDelta, _Vec4 vCenter, _Vec3 vRevolveAxis, _float fAngle, _float fTimeInterval, _float fRandomRatio)
{
	if (1.f < fRenderRatio)
		fRenderRatio = 1.f;
	else if (fRenderRatio < 0.f)
	...
	for (size_t i = 0; i < m_iNumInstance; i++)
	{
		...
		_Vec4		vMoveDir = vStartDir * m_pSpeed[i] * fSpeed;
		vMoveDir.y -= fGravity * pVertices[i].vLifeTime.y;
...
_bool CVIBuffer_Point_Instance::Converge(_uint iState, _float fRenderRatio, _Vec4 vPivot, _float fSpeed, _float fTimeDelta, _Vec3 vRevolveAxis, _float fAngle, _float fTimeInterval, _float fRandomRatio)
{
	if (1.f < fRenderRatio)
		fRenderRatio = 1.f;
	else if (fRenderRatio < 0.f)
...
_bool CVIBuffer_Point_Instance::Spread_Independent(_uint iState, _Matrix WorldMatrix, _float fRenderRatio, _Vec4 vPivot, _float fSpeed, _float fGravity, _float fTimeDelta, _Vec3 vRevolveAxis, _float fAngle, _float fTimeInterval, _float fRandomRatio)
{
	if (1.f < fRenderRatio)
		fRenderRatio = 1.f;
	else if (fRenderRatio < 0.f)
...
_bool CVIBuffer_Point_Instance::Move_Independent(_uint iState, _Matrix WorldMatrix, _float fRenderRatio, _Vec4 vDir, _float fSpeed, _float fGravity, _float fTimeDelta, _Vec4 vCenter, _Vec3 vRevolveAxis, _float fAngle, _float fTimeInterval, _float fRandomRatio)
{
	if (1.f < fRenderRatio)
		fRenderRatio = 1.f;
	else if (fRenderRatio < 0.f)
...
_bool CVIBuffer_Point_Instance::Converge_Independent(_uint iState, _Matrix WorldMatrix, _float fRenderRatio, _Vec4 vPivot, _float fSpeed, _float fTimeDelta, _Vec3 vRevolveAxis, _float fAngle, _float fTimeInterval, _float fRandomRatio)
{
	if (1.f < fRenderRatio)
		fRenderRatio = 1.f;
	else if (fRenderRatio < 0.f)
