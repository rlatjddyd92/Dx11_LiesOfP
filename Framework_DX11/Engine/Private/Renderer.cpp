...
HRESULT CRenderer::Initialize()
{
...
#ifdef _DEBUG
	//if (FAILED(m_pGameInstance->Ready_RT_Debug(TEXT("Target_PickObjectDepth"), 100.f, 100.f, 200.f, 200.f)))
	//	return E_FAIL;
	...
	if (FAILED(m_pGameInstance->Ready_RT_Debug(TEXT("Target_PickObjectDepth"), 300.f, 100.f, 200.f, 200.f)))
			return E_FAIL;
#endif
...
HRESULT CRenderer::Render_Lights()
{
	...
	if (FAILED(m_pShader->Bind_Matrices("g_CascadeViewMatrix", m_pGameInstance->Get_CascadeViewMatrices(), 3)))
		return E_FAIL;
	if (FAILED(m_pShader->Bind_Matrices("g_CascadeProjMatrix", m_pGameInstance->Get_CascadeProjMatrices(), 3)))
		return E_FAIL;
