...
class CState_Player_Scissor_Buff : public CState
{
public:
    CState_Player_Scissor_Buff(class CFsm* pFsm, class CPlayer* pPlayer);
    virtual ~CState_Player_Scissor_Buff() = default;
...
private:
    ...
    _uint               m_iAnimation_ScissorBuff= {};
