...
namespace Client
{
	...
	enum CUTSCENE_INDEX {BOSS1_MEET, BOSS1_PHASE2, BOSS1_DEAD, SOPHIA_ENTER, BOSS2_MEET, BOSS2_PHASE2, BOSS2_DEFEAT, SOPHIA_DEAD, BOSS2_MEET2, BOSS2_MEET3, CUTSCENE_END };
