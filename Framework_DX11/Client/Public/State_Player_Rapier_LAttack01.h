...
class CState_Player_Rapier_LAttack01 : public CState
{
public:
    CState_Player_Rapier_LAttack01(class CFsm* pFsm, class CPlayer* pPlayer);
    virtual ~CState_Player_Rapier_LAttack01() = default;
