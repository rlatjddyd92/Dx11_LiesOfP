...
class CState_Player_Flame_RAttack00 : public CState
{
public:
    CState_Player_Flame_RAttack00(class CFsm* pFsm, class CPlayer* pPlayer);
    virtual ~CState_Player_Flame_RAttack00() = default;
