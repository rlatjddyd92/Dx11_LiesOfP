...
class CState_CarcassBigA_AttackRoute_2 :
    public CState
{
private:
    typedef enum {
...
public:
    ...
    virtual ~CState_CarcassBigA_AttackRoute_2() = default;
...
public:
    static CState_CarcassBigA_AttackRoute_2* Create(class CFsm* pFsm, class CMonster* pMonster, _uint iStateNum, void* pArg = nullptr);
