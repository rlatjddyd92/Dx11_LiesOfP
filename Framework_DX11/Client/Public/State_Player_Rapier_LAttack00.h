...
class CState_Player_Rapier_LAttack00 : public CState
{
public:
    CState_Player_Rapier_LAttack00(class CFsm* pFsm, class CPlayer* pPlayer);
    virtual ~CState_Player_Rapier_LAttack00() = default;
