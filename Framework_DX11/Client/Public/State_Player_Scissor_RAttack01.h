...
class CState_Player_Scissor_RAttack01 : public CState
{
public:
    CState_Player_Scissor_RAttack01(class CFsm* pFsm, class CPlayer* pPlayer);
    virtual ~CState_Player_Scissor_RAttack01() = default;
