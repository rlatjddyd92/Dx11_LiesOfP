...
public:
	...
	enum RAXASIA_P2_STATE {
		...
		, ATKP2_RUN_LINKED, ATKP2_RUN_FURY, ATKP2_WAVESTING
		, ATKP2_TELE_JUMPLIGHTNING, ATKP2_TELE_LINKEDTEL
		, ATKP2_GUARD, ATKP2_GUARD_LINKED, ATKP2_GUARD_PUSH, ATKP2_GUARD_RUSH, ATK_P2_GUARD_CHARGE
	};
