...
class CState_Player_Flame_Charge01 : public CState
{
public:
    CState_Player_Flame_Charge01(class CFsm* pFsm, class CPlayer* pPlayer);
    virtual ~CState_Player_Flame_Charge01() = default;
