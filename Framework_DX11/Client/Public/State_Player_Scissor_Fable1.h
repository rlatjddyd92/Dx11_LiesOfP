...
class CState_Player_Scissor_Fable1 : public CState
{
public:
    CState_Player_Scissor_Fable1(class CFsm* pFsm, class CPlayer* pPlayer);
    virtual ~CState_Player_Scissor_Fable1() = default;
