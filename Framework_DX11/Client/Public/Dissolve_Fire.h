...
class CDissolve_Fire final : public CDissolve_Effect
{
private:
	CDissolve_Fire(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CDissolve_Fire(const CDissolve_Fire& Prototype);
	virtual ~CDissolve_Fire() = default;
...
public:
	static CDissolve_Fire* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	virtual CDissolve_Fire* Clone(void* pArg);
