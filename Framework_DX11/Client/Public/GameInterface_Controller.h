...
#pragma region UIManager
	...
	{ m_pUIManager->ShowTestPage(eFunction, DataNameA, eTypeA, ValueA, DataNameB, eTypeB, ValueB, DataNameC, eTypeC, ValueC, DataNameD, eTypeD, ValueD, DataNameE, eTypeE, ValueE,
