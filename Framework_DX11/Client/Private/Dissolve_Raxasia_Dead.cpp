...
HRESULT CDissolve_Raxasia_Dead::Initialize(void* pArg)
{
    ...
    m_pRaxasiaTransformCom = pDesc->pRaxasiaTransformCom;
    Safe_AddRef(m_pRaxasiaTransformCom);
...
void CDissolve_Raxasia_Dead::Update(_float fTimeDelta)
{
    ...
    Movement.WorldMatrix = m_pRaxasiaTransformCom->Get_WorldMatrix();
...
void CDissolve_Raxasia_Dead::Reset()
{
    CVIBuffer_Instancing::PARTICLE_MOVEMENT Movement = {};
    CVIBuffer_Dissolve_Instance::DISSOLVE_DATA Data = {};
...
HRESULT CDissolve_Raxasia_Dead::Ready_Componet()
{
    ...
    /* FOR.Com_Container */
    if (FAILED(__super::Add_Component(LEVEL_GAMEPLAY, TEXT("Prototype_Component_VIBuffer_Dissolve_Raxasia_Dead"),
...
void CDissolve_Raxasia_Dead::Free()
{
    ...
    Safe_Release(m_pRaxasiaTransformCom);
