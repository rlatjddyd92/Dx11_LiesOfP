...
void CTexture_Effect::Update(_float fTimeDelta)
{
    ...
    m_pTransformCom->Rotation(m_pTransformCom->Get_State(CTransform::STATE_LOOK), 
        XMConvertToRadians(m_DefaultDesc.fRotationAngle) + m_fAccumulateTime * XMConvertToRadians(m_DefaultDesc.fRotationSpeed));
