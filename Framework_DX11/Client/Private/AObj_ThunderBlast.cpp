...
CAObj_ThunderBlast::CAObj_ThunderBlast(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
    : CAttackObject{ pDevice, pContext }
{
}

CAObj_ThunderBlast::CAObj_ThunderBlast(const CGameObject& Prototype)
    : CAttackObject{ Prototype }
{
}

HRESULT CAObj_ThunderBlast::Initialize_Prototype()
{
    return S_OK;
}

HRESULT CAObj_ThunderBlast::Initialize(void* pArg)
{
...
void CAObj_ThunderBlast::Priority_Update(_float fTimeDelta)
{
...
void CAObj_ThunderBlast::Late_Update(_float fTimeDelta)
{
...
HRESULT CAObj_ThunderBlast::Render()
{
#ifdef DEBUG
...
HRESULT CAObj_ThunderBlast::Render_LightDepth()
{
    return S_OK;
}

void CAObj_ThunderBlast::OnCollisionEnter(CGameObject* pOther)
{
...
void CAObj_ThunderBlast::OnCollisionStay(CGameObject* pOther)
{
}

void CAObj_ThunderBlast::OnCollisionExit(CGameObject* pOther)
{
}

HRESULT CAObj_ThunderBlast::Ready_Components()
{
    ...
    m_pEffect = CEffect_Manager::Get_Instance()->Clone_Effect(TEXT("Raxasia_Attack_ThunderStamp_Mark_Explositon"), pParetnMatrix,
...
CAObj_ThunderBlast* CAObj_ThunderBlast::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
{
    CAObj_ThunderBlast* pInstance = new CAObj_ThunderBlast(pDevice, pContext);

    if (FAILED(pInstance->Initialize_Prototype()))
    {
        MSG_BOX(TEXT("Failed to Created : CAObj_ThunderBlast"));
...
CGameObject* CAObj_ThunderBlast::Clone(void* pArg)
{
    CAObj_ThunderBlast* pInstance = new CAObj_ThunderBlast(*this);

    if (FAILED(pInstance->Initialize(pArg)))
    {
        MSG_BOX(TEXT("Failed to Cloned : CAObj_ThunderBlast"));
        Safe_Release(pInstance);
    }
