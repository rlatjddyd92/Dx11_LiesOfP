...
HRESULT CState_Player_Rapier_Fatal::Initialize(_uint iStateNum, void* pArg)
{
    ...
    m_iColliderStartFrame[0] = 32;
    m_iColliderEndFrame[0] = 43;
    m_iColliderStartFrame[1] = 94;
    m_iColliderEndFrame[1] = 104;
...
{
    m_pPlayer->Change_Animation(m_iAnimation_RapierFatal, false, 0.05f);
...
{
    return m_pPlayer->Get_EndAnim(m_iAnimation_RapierFatal);
}
