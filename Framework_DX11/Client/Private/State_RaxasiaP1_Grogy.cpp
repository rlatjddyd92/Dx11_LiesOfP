...
CState_RaxasiaP1_Grogy::CState_RaxasiaP1_Grogy(CFsm* pFsm, CMonster* pMonster)
    :CState{ pFsm }
    , m_pMonster{ pMonster }
{
}

HRESULT CState_RaxasiaP1_Grogy::Initialize(_uint iStateNum, void* pArg)
{
...
void CState_RaxasiaP1_Grogy::Update(_float fTimeDelta)
{
...
_bool CState_RaxasiaP1_Grogy::End_Check()
{
...
CState_RaxasiaP1_Grogy* CState_RaxasiaP1_Grogy::Create(CFsm* pFsm, CMonster* pMonster, _uint iStateNum, void* pArg)
{
    CState_RaxasiaP1_Grogy* pInstance = new CState_RaxasiaP1_Grogy(pFsm, pMonster);

    if (FAILED(pInstance->Initialize(iStateNum, pArg)))
    {
        MSG_BOX(TEXT("Failed to Created : CState_RaxasiaP1_Grogy"));
...
void CState_RaxasiaP1_Grogy::Free()
{
    __super::Free();
}