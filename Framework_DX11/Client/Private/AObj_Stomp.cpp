...
void CAObj_Stomp::OnCollisionEnter(CGameObject* pOther)
{
    ...
    if (pOther->Get_Tag() == TEXT("Player"))
    {
        ...
        if (!bOverlapCheck)
        {
            ...
            _bool bHitCheck = pOther->Calc_DamageGain(m_fDamageAmount * m_fDamageRatio, _Vec3{}, HIT_TYPE::HIT_METAL, ATTACK_STRENGTH::ATK_STRONG);
...
HRESULT CAObj_Stomp::Ready_Components()
{
    ...
    m_pEffect = CEffect_Manager::Get_Instance()->Clone_Effect(TEXT("SimonManus_PowerAttack_Stamp"), pParetnMatrix,
