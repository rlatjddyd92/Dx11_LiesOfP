...
CState_RebornerMaleFire_HitFatal::CState_RebornerMaleFire_HitFatal(CFsm* pFsm, CMonster* pMonster)
    :CState{ pFsm }
    , m_pMonster{ pMonster }
{
}

HRESULT CState_RebornerMaleFire_HitFatal::Initialize(_uint iStateNum, void* pArg)
{
...
HRESULT CState_RebornerMaleFire_HitFatal::Start_State(void* pArg)
{
    m_iAnimTrack = 0;
...
void CState_RebornerMaleFire_HitFatal::Update(_float fTimeDelta)
{
    switch (m_iAnimTrack)
    {
    case 0:     //페이탈 시작
...
void CState_RebornerMaleFire_HitFatal::End_State()
{
    m_fHitFatalTime = 0.f;
}

_bool CState_RebornerMaleFire_HitFatal::End_Check()
{
...
CState_RebornerMaleFire_HitFatal* CState_RebornerMaleFire_HitFatal::Create(CFsm* pFsm, CMonster* pMonster, _uint iStateNum, void* pArg)
{
    CState_RebornerMaleFire_HitFatal* pInstance = new CState_RebornerMaleFire_HitFatal(pFsm, pMonster);

    if (FAILED(pInstance->Initialize(iStateNum, pArg)))
    {
        MSG_BOX(TEXT("Failed to Created : CState_RebornerMaleFire_HitFatal"));
...
void CState_RebornerMaleFire_HitFatal::Free()
{
    __super::Free();
}