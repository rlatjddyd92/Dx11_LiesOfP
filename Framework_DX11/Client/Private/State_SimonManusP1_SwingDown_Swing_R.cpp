...
void CState_SimonManusP1_SwingDown_Swing_R::Collider_Check(_double CurTrackPos)
{
    if (m_iRouteTrack == 0)
    {
...
void CState_SimonManusP1_SwingDown_Swing_R::Effect_Check(_double CurTrackPos)
{
    if (m_iRouteTrack == 0)
    {
        if (!m_bStampEffect)
